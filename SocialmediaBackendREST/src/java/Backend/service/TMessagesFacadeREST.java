 ...
 * concerning the TMessages entity. Apart from the autogenerated methods to 
 * create, find, edit and delete entities there are methods to find messages with
 * a specific receiver and to find messages from a specific sender to a specific
 * receiver. There is also a method to set a message to IsRead == true.
 */
@Stateless
